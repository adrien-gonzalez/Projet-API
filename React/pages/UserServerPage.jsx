    ...
    if (props.serversRedux.info != null) {
      props.serversRedux.info.map((s) => {
        if (serverId == s.id) {
          const action = {
            type: "UPDATE_SERVERS",
            value: { info: props.serversRedux.info, isUpdated: true },
          };
              ...
              >
                <View style={styles.miniature}>
                  <ImageBackground
                    source={{
                      uri:
                        "http://nicolas-camilloni.students-laplateforme.io/assets/miniature_server/" +
                        userServer.miniature +
                        "?time=" +
                        new Date(),
                    }}
                ...
                >
                  ...
                  <Text style={{ fontSize: 14, color: userServer.color }}>
                    {userServer.nameGame}
                  </Text>
                </View>
                <View style={styles.infoServer}>
                  <View
                    style={{
                      ...
                      width: "100%",
                      backgroundColor: userServer.color,
                      padding: 5,
                    }}
                  >
                    <View style={{ alignItems: "center" }}>
                      <AntDesign name="like2" size={16} color="white" />
                      <Text style={styles.detailServer}>
                        {userServer.vote} Vote(s)
                      </Text>
                    </View>
                    <View style={{ alignItems: "center" }}>
                      <FontAwesome name="comment-o" size={16} color="white" />
                      <Text style={styles.detailServer}>
                        {userServer.avis} Avi(s)
                      </Text>
                    </View>
                    <View style={{ alignItems: "center" }}>
                  ...
                  >
                    ...
                    <View>
                      <TouchableOpacity
                        onPress={() => {
                          setIdServer(userServer.id), setModalVisible(true);
                        }}
                      >
                        <View style={{ alignItems: "center" }}>
    ...
    return (
      ...
      >
        <Topbar
          ...
          backgroundColor={props.apparence.dark ? "#080015" : "white"}
        />
        {myServer(userServer)}
        <Modal
          animationType="slide"
          ...
          <View style={styles.centeredView}>
            ...
            >
              ...
              <Text style={styles.modalInfos}>
                Cette action supprimera immédiatement votre serveur et vous ne
                    ...
                    <View style={styles.fixToText}>
                      <TouchableOpacity
                        style={{
                          ...
                          paddingTop: 10,
                          paddingBottom: 10,
                          backgroundColor: props.apparence.dark
                            ? "#242048"
                            : "white",
